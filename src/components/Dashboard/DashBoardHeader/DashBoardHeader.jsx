...
import logo from '../images/logocircul.png'

const DashBoardHeader = () => { 
    const user = useSelector(state => state.auth.user[0])
    
    return (
        <div className={style.dasnboardheader}>
            <div className={style.leftBlock}><img src={logo} alt='логотип'/></div>
            <div className={style.centerBlock}>
                <button className={style.roundedCircle}>
                ...
                <div class={style.myAccWrapper}>
                    <div className={style.avatName}>
                        ...
                        <div class={style.userInfo}>
                            ...
                            <p class={style.mb-0}>{user.phone}</p>
                        </div>
                    </div>
                </div>
            </div>
