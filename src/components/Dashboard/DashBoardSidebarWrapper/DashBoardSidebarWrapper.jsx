import style from './DashBoardSidebarWrapper.module.css'
import React, { useState, useEffect } from 'react';
import {useDispatch, useSelector } from 'react-redux'
import { getAllOrdersThunkCreator } from './../../../redux/dashboard/order-reducer'
...
const DashBoardSidebarWrapper = () => { 
    ...
    useEffect(() => {
        dispatch(getAllOrdersThunkCreator())
        
    }, [dispatch]);

    const currentOrder = orders.filter(item => item.isread === 0)
    ...
    return (
        <div className={style.sidebarWrapper}>
           <ul>
            <li>
                <a href="/admin">
                    <button className={`${style.sidebarButton} ${style.active}`}  tabindex="0" type="button">
                        <span class={style.icon}>
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                <path fill="none" d="M0 0h24v24H0z"></path><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"></path>
                            </svg>
                        </span>
                       <p>Dashboard</p> 
                    </button>
            ...
            <NavLink to="/admin/tickets" >
                <li>
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 0 ? style.active : ''}`} 
            ...
            <li className={style.posRel}>
                <a href="/admin/orders">
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 1 ? style.active : ''}`} 
                       ...
                       <p> Заказы</p>
                        ...
                        {currentOrder.length > 0 ? <span className={style.currentOrder}>{currentOrder.length}</span> : null}
                    </button>
                </a>
            ...
            <li>
                <a href="/admin/events">
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 2 ? style.active : ''}`} 
            ...
            <li>
                <a href="/admin/acters">
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 3 ? style.active : ''}`} 
            ...
            <li>
                <a href="/admin/locations">
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 4 ? style.active : ''}`} 
            ...
            <a href="/admin/messages">
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 5 ? style.active : ''}`} 
                        ...
                        >
                        <span class={style.icon}>
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"></path></svg>
            ...
            <a href="/admin/notifications">
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 6 ? style.active : ''}`} 
            ...
            <a href="/admin/users">
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 7 ? style.active : ''}`} 
            ...
            <li>
                <a href="/admin/settings">
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 8 ? style.active : ''}`} 
            ...
            <li> <a href="/">
                    <button 
                            className={`${style.sidebarButton} ${isHovered === 9 ? style.active : ''}`} 
